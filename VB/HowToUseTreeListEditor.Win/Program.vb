...
Imports HowToUseTreeListEditor.Win
...
Public Class Program
    ...
    Public Shared Sub Main(ByVal arguments() As String)
        ...
        Dim _application As HowToUseTreeListEditorWindowsFormsApplication = New HowToUseTreeListEditorWindowsFormsApplication()
        _application.ConnectionString = HowToUseTreeListEditor.Module.CodeCentralExampleInMemoryDataStoreProvider.ConnectionString

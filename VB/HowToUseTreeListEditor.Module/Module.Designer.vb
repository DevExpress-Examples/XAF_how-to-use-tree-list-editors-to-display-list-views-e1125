...
Partial Public Class HowToUseTreeListEditorModule
    ''' <summary> 
...
#Region "Component Designer generated code"
    ...
    Private Sub InitializeComponent()
      '
      'HowToUseTreeListEditorModule
      '
      Me.AdditionalBusinessClasses.Add(GetType(DevExpress.Persistent.BaseImpl.HCategory))
